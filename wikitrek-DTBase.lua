-- [P2G] Auto upload by PageToGitHub on 2021-10-07T18:34:15+02:00
...
{{!}}}
	...
	if not Item["P7"] then
		...
		Previous = Item["P7"][1] --p.LabelOrLink(Item["P7"][1].datavalue.value.id)
	end
	...
	Table = "<div class='separatorebox'>'''" .. Title[1] .. "'''</div>"
