-- [P2G] Auto upload by PageToGitHub on 2021-10-07T22:33:41+02:00
	...
	for _, Property in pairs(AllP) do
		if (not ExcludeP[Property]) and Item.claims[Property][1].mainsnak.datatype ~= 'external-id' then
			...
			elseif (Property == "P7" or Property == "P23") and CollectionTable == '' then
				--Previous or Next
				CollectionTable = string.char(10) .. Item.claims[Property][1].mainsnak.datavalue.value.id -- MakeNavTable(Item.claims, Item.claims[Property][1].mainsnak.datavalue.value.id)
