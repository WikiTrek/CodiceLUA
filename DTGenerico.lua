-- [P2G] Auto upload by PageToGitHub on 2020-04-04T16:52:11+02:00
...
function p.Incipit(frame)
	...
	return "'''" .. frame:expandTemplate{title = 'PAGENAME'} .. "''' è un " .. mw.wikibase.getLabelByLang(p.QFromP('P14'), 'it') .. string.char(10)
end
